...
::: {.fragment style="font-size: 1.5em;"}
$$\require{enclose} \require{color}
\displaystyle \dfrac{1\rlap{\enclose{updiagonalstrike}[mathcolor="red"]{\phantom{(j\omega + 2)}}}(j\omega + 2)}{\rlap{\enclose{updiagonalstrike}[mathcolor="red"]{\phantom{(j\omega + 2)}}}(j\omega + 2)(j\omega + 4)} = \dfrac{A\rlap{\enclose{updiagonalstrike}[mathcolor="red"]{\phantom{(j\omega + 2)}}}(j\omega + 2)}{\rlap{\enclose{updiagonalstrike}[mathcolor="red"]{\phantom{(j\omega + 2)}}}(j\omega + 2)} + \dfrac{B(j\omega + 2)}{(j\omega + 4)}$$
:::
...
::: {.fragment style="font-size: 1.5em;"}
$$\require{enclose} \require{color}
\displaystyle \dfrac{1\rlap{\enclose{updiagonalstrike}[mathcolor="red"]{\phantom{(j\omega + 4)}}}(j\omega + 4)}{(j\omega + 2)\rlap{\enclose{updiagonalstrike}[mathcolor="red"]{\phantom{(j\omega + 4)}}}(j\omega + 4)} = \dfrac{A(j\omega + 4)}{(j\omega + 2)} + \dfrac{B\rlap{\enclose{updiagonalstrike}[mathcolor="red"]{\phantom{(j\omega + 4)}}}(j\omega + 4)}{\rlap{\enclose{updiagonalstrike}[mathcolor="red"]{\phantom{(j\omega + 4)}}}(j\omega + 4)}$$
:::
